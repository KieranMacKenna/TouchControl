	...
	public class FacebookGUIManager : MonoBehaviourGUI
	{
		...
		void secondColumnButtonsGUI()
		{
			if( GUILayout.Button( "Show Share Dialog" ) )
			{
				...
				FacebookBinding.showFacebookShareDialog( content );
			}
			
			
			if( GUILayout.Button( "Show Share Dialog with Image" ) )
			{
				var pathToImage = Application.persistentDataPath + "/" + FacebookGUIManager.screenshotFilename;
				FacebookBinding.showFacebookShareDialogWithImage( pathToImage, "This is the image caption" );
			}
		...
		void secondColumnAdditionalButtonsGUI()
		{
